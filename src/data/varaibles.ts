...
export const weightVariable: WeightVariable[] = [
...
export const heightVariable: HeightVariable[] = [
...
export const bootsLengthVariable: BootsLengthVariable[] = [
