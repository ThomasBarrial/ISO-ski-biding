const skierSettings = [
  ...
  },
  {
    ...
    bootsSize: [
      ...
      { index: 1, name: "271-290", DIN: 3.0 },
      { index: 2, name: "291-310", DIN: 3.0 },
  ...
  },
  {
    ...
    bootsSize: [
      ...
      { index: 1, name: "271-290", DIN: 4.0 },
      { index: 2, name: "291-310", DIN: 3.5 },
      { index: 3, name: "311-330", DIN: 3.5 },
      { index: 4, name: "331-350", DIN: 3.0 },
    ],
  },
  {
    index: 9,
    ...
    bootsSize: [
      ...
      { index: 1, name: "271-290", DIN: 5.0 },
      { index: 2, name: "291-310", DIN: 4.5 },
      { index: 3, name: "311-330", DIN: 4.0 },
      { index: 4, name: "331-350", DIN: 3.5 },
      { index: 5, name: "+351", DIN: 3.0 },
    ],
  },
  {
    index: 10,
    ...
    bootsSize: [
      ...
      { index: 1, name: "271-290", DIN: 6.0 },
      { index: 2, name: "291-310", DIN: 5.5 },
      { index: 3, name: "311-330", DIN: 5.0 },
      { index: 4, name: "331-350", DIN: 4.5 },
      { index: 5, name: "+351", DIN: 4.0 },
    ],
  },
  {
    index: 11,
    ...
    bootsSize: [
      ...
      { index: 1, name: "271-290", DIN: 7.0 },
      { index: 2, name: "291-310", DIN: 6.5 },
      { index: 3, name: "311-330", DIN: 6.0 },
      { index: 4, name: "331-350", DIN: 5.5 },
      { index: 5, name: "+351", DIN: 5.0 },
    ],
  },
  {
    index: 12,
    ...
    height: "+195",
    bootsSize: [
      { index: 1, name: "271-290", DIN: 8.5 },
      { index: 2, name: "291-310", DIN: 8.0 },
      { index: 3, name: "311-330", DIN: 7.0 },
      { index: 4, name: "331-350", DIN: 6.5 },
      { index: 5, name: "+351", DIN: 6.0 },
    ],
  },
  {
    index: 13,
    ...
    height: "none",
    bootsSize: [
      { index: 0, name: "271-291", DIN: 10.0 },
      { index: 1, name: "291-310", DIN: 9.5 },
      { index: 2, name: "311-330", DIN: 8.5 },
      { index: 3, name: "331-350", DIN: 8.0 },
  ...
  },
  {
    ...
    bootsSize: [
      ...
      { index: 1, name: "291-310", DIN: 11.0 },
      { index: 2, name: "311-330", DIN: 10.0 },
      { index: 3, name: "331-350", DIN: 9.5 },
      { index: 4, name: "+351", DIN: 9.0 },
    ],
  },
  {
    index: 15,
    ...
    height: "none",
    bootsSize: [
      { index: 2, name: "311-330", DIN: 12.0 },
      { index: 3, name: "331-350", DIN: 11.0 },
